...
$("#btn--modal--1").click(function (e) {
	...
	if (($('#phone--1').inputmask("isComplete")) && ($('#name--1').val().length !== 0)) {
...
//     if (win.width() >= 1024) {
// 		$('.nav__sub-menu.nav__link').click(function(){return false;});
// 	 }
...
//  const subMenuHidden = this.document.querySelector('.nav__sub-menu')
// 		if (width >= 1100) {
// 		subMenuHidden.addEventListener('click',function () {
// 			console.log(1)
// 			return false;
// 		})
